    ...
    return (
        <section className={styles.Gallery}>
            <div className={styles.GalleryButtons}>
                ...
                <span className={styles.BtnGrid} onClick={() => setGrid(3)}>3</span>
                <span className={styles.BtnGrid} onClick={() => setGrid(5)}>5</span>
            </div>
            {status === 'loading' && <div className={styles.LoaderContainer}>
